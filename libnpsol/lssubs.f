...
*
*     Systems Optimization Laboratory, Stanford University.
*     This version of  LSCORE  dated  13-May-1988.
*
...
C     Original version written 31-October-1984.
C     Level-2 matrix routines added 25-Apr-1988.
C     This version of LSDEL dated  26-Jun-1989.
C***********************************************************************
      COMMON    /SOL1CM/ NOUT
      COMMON    /SOL5CM/ ASIZE, DTMAX, DTMIN
...
*           T becomes reverse lower Hessenberg.
  ...
  220       CONTINUE
         ...
         ELSE
*           ------------------------------------------------------------
*           Restore the nactiv x (nactiv+1) reverse-Hessenberg matrix  T
*           to reverse-triangular form.  The last nactiv super-diagonal 
*           elements are removed using a backward sweep of plane 
*           rotations.  The rotation for the singleton in the first
*           column is generated separately.
*           ------------------------------------------------------------
            NSUP   = NACTIV - ITDEL + 1
...
*              of  R.  A subdiagonal element is generated that must be 
*              eliminated by a row rotation before the next column 
...
*     Local variables.
     ...
     $                   UNITQ , VERTEX
      ...
      CHARACTER*40       TITLE
      DATA               TITLE
     $                 / 'SOL/LSSOL  ---  Version 1.03   Jun  1989' /
